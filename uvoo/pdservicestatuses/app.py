...
PD_SYNC_INTERVAL_SECONDS = int(os.getenv('PD_SYNC_INTERVAL_SECONDS', 600))
try:
    PD_INCIDENT_SEARCH_PERIOD_DAYS = int(os.getenv('PD_INCIDENT_SEARCH_PERIOD_DAYS', 90))
    print(f"PD_INCIDENT_SEARCH_PERIOD_DAYS type: {type(PD_INCIDENT_SEARCH_PERIOD_DAYS)}, value: {PD_INCIDENT_SEARCH_PERIOD_DAYS}")
except ValueError:
